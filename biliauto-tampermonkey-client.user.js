...
:root {
  ...
  --tm-input-bg: #f5f5f5;
  --tm-surface: #f5f5f5;
  --tm-shadow: 0 11px 15px -7px rgba(0,0,0,0.2), 0 24px 38px 3px rgba(0,0,0,0.14), 0 9px 46px 8px rgba(0,0,0,0.12);
  --tm-shadow-btn: 0 3px 1px -2px rgba(0,0,0,0.2), 0 2px 2px 0 rgba(0,0,0,0.14), 0 1px 5px 0 rgba(0,0,0,0.12);
  --tm-radius: 10px;
  --tm-radius-btn: 6px;
  --tm-radius-chip: 32px;
  --tm-font: Roboto, "Noto Sans SC", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
...
#biliauto-login-overlay {
  ...
  inset: 0;
  z-index: 2147483647;
  background: var(--tm-bg-card, #1e1e1e);
  display: flex;
  align-items: center;
  justify-content: center;
  opacity: 0;
...
.tm-overlay-card {
  background: var(--tm-surface, #2c2c2c);
  border-radius: 16px;
  padding: 36px 40px;
  text-align: center;
  max-width: 380px;
  ...
  border: 1px solid var(--tm-divider, rgba(255,255,255,0.12));
}
.tm-overlay-title {
  font-size: 20px;
  font-weight: 700;
...
.tm-overlay-desc {
  font-size: 13px;
  color: var(--tm-text-secondary, #999);
  margin-bottom: 20px;
  line-height: 1.6;
}
.tm-overlay-hint {
  font-size: 15px;
  font-weight: 600;
  color: var(--tm-primary, #4fc3f7);
  margin: 12px 0;
  line-height: 1.5;
}
.tm-overlay-group {
  display: inline-block;
  background: var(--tm-primary, #4fc3f7);
  color: #000;
  font-weight: 700;
  font-size: 16px;
  padding: 4px 14px;
...
.tm-overlay-code-label {
  font-size: 11px;
  color: var(--tm-text-hint, #777);
  margin-bottom: 6px;
}
.tm-overlay-code {
  font-size: 42px;
...
.tm-overlay-btn:hover { opacity: 0.85; }
.tm-overlay-btn:active { opacity: 0.7; }
